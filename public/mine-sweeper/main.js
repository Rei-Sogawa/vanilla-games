...
const clearAudio = new Audio("./mine-sweeper/clear.mp3");
const bombAudio = new Audio("./mine-sweeper/bomb.mp3");
...
function getBombArray() {
  ...
  const onlyEmptyArray = new Array(
    width * height - bombAmount - blockAmount
  ).fill("empty");
